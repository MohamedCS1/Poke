            ...
            .map(object :Function<PokemonResponse ,ArrayList<Pokemon>>{
                override fun apply(t: PokemonResponse): ArrayList<Pokemon> {
                    ...
                    for (pokemon in list)
                    {
                        ...
                        pokemon.url = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${pokemonIndex[pokemonIndex.size-2]}.png"
                    }
                    return list
                }

            }).observeOn(AndroidSchedulers.mainThread()).subscribe(object :Consumer<ArrayList<Pokemon>>{
